...
public class DummySentenceDetectorFactory extends SentenceDetectorFactory {
	...
	public DummySentenceDetectorFactory(String languageCode, boolean useTokenEnd, Dictionary abbreviationDictionary,
			char[] eosCharacters) {
	...
	public SDContextGenerator getSDContextGenerator() {
		return new DummySDContextGenerator(getAbbreviationDictionary().asStringSet(), getEOSCharacters());
	}
