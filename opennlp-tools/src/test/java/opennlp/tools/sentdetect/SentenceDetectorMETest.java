...
public class SentenceDetectorMETest {
	...
	public void testSentenceDetector() throws IOException {
		...
		SentenceModel sentdetectModel = SentenceDetectorME.train("eng",
	...
	public void testInsufficientData() throws IOException {
		...
		SentenceDetectorME.train("eng", new SentenceSampleStream(new PlainTextByLineStream(in, StandardCharsets.UTF_8)),
				factory, mlParams);
