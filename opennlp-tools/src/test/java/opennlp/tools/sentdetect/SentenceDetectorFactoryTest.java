...
public class SentenceDetectorFactoryTest {
	...
	private static ObjectStream<SentenceSample> createSampleStream() throws IOException {
		InputStreamFactory in = ResourceAsStreamFactory.mockInputStreamFactory1(SentenceDetectorFactoryTest.class,
	...
	private static SentenceModel train(SentenceDetectorFactory factory) throws IOException {
		return SentenceDetectorME.train("eng", createSampleStream(), factory, TrainingParameters.defaultParams());
	}
	...
	public void testDummyFactory() throws IOException {
		...
		char[] eos = { '.', '?' };
		SentenceModel sdModel = train(new DummySentenceDetectorFactory("eng", true, dic, eos));
	...
	public void testCreateDummyFactory() throws IOException {
		...
		SentenceDetectorFactory factory = SentenceDetectorFactory
				.create(DummySentenceDetectorFactory.class.getCanonicalName(), "spa", false, dic, eos);
