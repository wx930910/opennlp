...
public class DoccatFactoryTest {
	...
	private static ObjectStream<DocumentSample> createSampleStream() throws IOException {
		...
		InputStreamFactory isf = ResourceAsStreamFactory.mockInputStreamFactory1(DoccatFactoryTest.class,
	...
	private static DoccatModel train() throws IOException {
		return DocumentCategorizerME.train("x-unspecified", createSampleStream(), TrainingParameters.defaultParams(),
				new DoccatFactory());
	}
	...
	public void testCustom() throws IOException {
		FeatureGenerator[] featureGenerators = { new BagOfWordsFeatureGenerator(), new NGramFeatureGenerator(),
