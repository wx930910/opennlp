...
public class POSTaggerMETest {
	...
	private static ObjectStream<POSSample> createSampleStream() throws IOException {
		InputStreamFactory in = ResourceAsStreamFactory.mockInputStreamFactory1(POSTaggerMETest.class,
	...
	public void testPOSTagger() throws IOException {
		...
		String[] tags = tagger.tag(new String[] { "The", "driver", "got", "badly", "injured", "." });
	...
	public void insufficientTestData() throws IOException {
		...
		ObjectStream<POSSample> stream = new WordTagSampleStream(new PlainTextByLineStream(in, StandardCharsets.UTF_8));
