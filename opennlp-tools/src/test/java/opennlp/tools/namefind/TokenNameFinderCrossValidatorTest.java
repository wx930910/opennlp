...
public class TokenNameFinderCrossValidatorTest {
	...
	public void testWithNullResources() throws Exception {
		...
		TokenNameFinderCrossValidator cv = new TokenNameFinderCrossValidator("eng", TYPE, mlParams, null,
	...
	public void testWithNameEvaluationErrorListener() throws Exception {
		...
		TokenNameFinderCrossValidator cv = new TokenNameFinderCrossValidator("eng", TYPE, mlParams, null, resources,
				listener);
