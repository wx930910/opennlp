...
public class NameFinderMETest {
	...
	public void testNameFinder() throws Exception {
		...
		ObjectStream<NameSample> sampleStream = new NameSampleDataStream(
				new PlainTextByLineStream(MockInputStreamFactory
						.mockInputStreamFactory2(new File("opennlp/tools/namefind/AnnotatedSentences.txt")), encoding));
	...
	public void testNameFinderWithTypes() throws Exception {
		...
		ObjectStream<NameSample> sampleStream = new NameSampleDataStream(
				new PlainTextByLineStream(MockInputStreamFactory.mockInputStreamFactory2(
	...
	public void testOnlyWithNames() throws Exception {
		...
		ObjectStream<NameSample> sampleStream = new NameSampleDataStream(new PlainTextByLineStream(
				MockInputStreamFactory.mockInputStreamFactory2(new File("opennlp/tools/namefind/OnlyWithNames.train")),
	...
	public void testOnlyWithEntitiesWithTypes() throws Exception {
		...
		ObjectStream<NameSample> sampleStream = new NameSampleDataStream(
				new PlainTextByLineStream(
						MockInputStreamFactory.mockInputStreamFactory2(
								new File("opennlp/tools/namefind/OnlyWithEntitiesWithTypes.train")),
						StandardCharsets.UTF_8));
	...
	public void testNameFinderWithMultipleTypes() throws Exception {
		...
		// train the name finder
		ObjectStream<NameSample> sampleStream = new NameSampleDataStream(new PlainTextByLineStream(
				MockInputStreamFactory.mockInputStreamFactory2(new File("opennlp/tools/namefind/voa1.train")),
				StandardCharsets.UTF_8));
