...
public class TokenizerFactoryTest {
	...
	private static ObjectStream<TokenSample> createSampleStream() throws IOException {
		InputStreamFactory in = ResourceAsStreamFactory.mockInputStreamFactory1(TokenizerFactoryTest.class,
	...
	public void testCustomPatternAndAlphaOpt() throws IOException {
		...
		TokenizerModel model = train(new TokenizerFactory(lang, dic, true, Pattern.compile(pattern)));
	...
	public void testDummyFactory() throws IOException {
		...
		TokenizerModel model = train(new DummyTokenizerFactory(lang, dic, true, Pattern.compile(pattern)));
	...
	public void testCreateDummyFactory() throws IOException {
		...
		TokenizerFactory factory = TokenizerFactory.create(DummyTokenizerFactory.class.getCanonicalName(), lang, dic,
				true, Pattern.compile(pattern));
