...
public class ADPOSSampleStreamTest {
	...
	public void testSimple() throws IOException {
		...
		try (ADPOSSampleStream stream = new ADPOSSampleStream(
				new PlainTextByLineStream(ResourceAsStreamFactory.mockInputStreamFactory1(ADParagraphStreamTest.class,
						"/opennlp/tools/formats/ad.sample"), StandardCharsets.UTF_8),
				false, false)) {
